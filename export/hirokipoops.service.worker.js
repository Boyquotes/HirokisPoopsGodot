...
const CACHED_FILES = ["hirokipoops.html","hirokipoops.js","hirokipoops.offline.html","hirokipoops.icon.png","hirokipoops.apple-touch-icon.png"];
// Files that we might not want the user to preload, and will only be cached on first load.
const CACHABLE_FILES = ["hirokipoops.wasm","hirokipoops.pck"];
